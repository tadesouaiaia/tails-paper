...
\texttt{pyreadr} is only needed for the simulation-figure component of \texttt{tails gen all}; however, the simplest setup is to install the full environment up front.
