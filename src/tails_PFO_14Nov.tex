...
biomedical research and precision medicine \cite{Timpson2018}. Despite much progress, 
...
using the standardised trait values in the base data, applying PLINK-1.9 \citep{plink, bt_10}, 
...
with heritability $h^2<5\%$ \cite{guide_paper}, while to ensure that the traits were 
...
individuals \citep{erase}, we selected a further 7 traits (two bone-densitometry related and five body 
