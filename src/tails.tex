...
the mean), only lower tail regression exhibited by haemoglobin
concentration, only upper tail exhibited by red blood cell
distribution width and dual tail exhibited by sitting height.

Across the 75 traits analysed, 80\% (121 of 150 tails exhibited
significant (FDR$<$0.05) movement away from expectation and that 98\%
(118 of 121) of the time the movement that occurs is regression to
the mean. \dref{fig:prs}{b}) shows results for all traits with
significant movement to the mean in at least one tail. The
majority of traits (47 of 75) were classified as "Dual Tail"
(significant, (FDR$<$0.05, regression to the mean in both tails), 15
were classified as "Lower Tail" and 9 were classified as "Upper Tail"
(see \dref{fig:prs}{b}).
