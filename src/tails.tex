...
\subsection*{Population-level data analyses for rare variants of large
  effect affecting the tails of trait
  distributions.} ~\\
...
The test is applied to 77 unique continuous UKB traits with
heritabilty $>0.05$, PRS $R^2>0.01$ and sample size $>$10,000, see
Methods for further details of trait QC.
