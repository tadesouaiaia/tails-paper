...
We demonstrate replication of these results across ancestries, cohorts, repeat measures, and using an 
orthogonal family-based approach \cite{Souaiaia2024}. Furthermore, trait tails with inferred 
enrichment of rare alleles are associated with more rare exome-based hits, advanced paternal 
age, reduced fecundity, and poor predictive performance of polygenic scores. 
Finally, we find evidence of ongoing selection consistent with observed
departures in polygenicity and demonstrate, via simulation, that traits under 
stabilising selection are expected to have tails enriched for rare alleles of large effect. 
This means that many individuals may have extreme trait values due to only one or several alleles 
of very large effect, contrary to the popular infinitesimal model \cite{Barton2017} of quantitative traits, 
which assumes that the genetic contribution to trait values is due only to total burden of many weak effects. 
Overall, our findings suggest that selection drives distinct genetic architecture in the tails of complex traits. 
Our study has implications for the discovery of rare variants, the utility of polygenic scores, 
the study of selection, and for the relative importance of common and rare variants to human traits and disease.
...
plethora of complex traits \cite{Flannick2019, Singh2022}. The number of variants 
...
characteristic "trumpet" shape \cite{Yengo2022, Corte2023} that reflects the action of natural selection
...
varies across the trait continuum. However, so far there has been no systematic investigation 
into how genetic architecture 
...
method \cite{Sanjak2018} that uses lifetime reproductive success to infer ongoing positive, 
...
to UKB non-European multi-ancestry individuals. This ‘Non-EUR UKB’ 
...
%
%
The UK Biobank (UKB) includes over 17k sibling pairs of European 
