...
\textbf{(a)} Trumpet plots illustrate the relationship between allele frequency and effect size. 
\textbf{(b)} Common alleles contribute to a greater proportion of heritability across the trait continuum. 
