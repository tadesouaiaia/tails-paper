...
\FloatBarrier \begin{figure}[!h] \begin{maybe}{showFig} \includegraphics[trim=0cm 0cm 0cm 0cm, clip, width=\linewidth]{Figures/Fig5_eur_qc_0_version1_dedupe.pdf} \end{maybe} 
  \caption{\footnotesize{{\bf Replication results in UKB non-European
      ...
      cohorts. \textbf{(g)}. \textbf{(h)} PRS-test effect sizes
      estimated in: UKB European ancestry samples v All Of Us European
      ancestry samples for 24 overlapping traits passing PRS-test QC
      in both cohorts.}  } \label{fig:rep} \end{figure} \FloatBarrier
