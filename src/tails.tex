...
We first applied our test to UKB samples of European ancestry.
Available samples were split equally, one half of the data was used
for GWAS to estimate PRS via PRSice and the remaining samples for
testing, see Methods for further details of sample selection and
genotype QC. Continuous traits with heritabilty $>0.05$, PRS
$R^2>0.01$ and sample size $>$10,000 were selected for analysis. After
removal of strongly correlated traits (maximum pairwise correlation
$R^2<$0.95 ) 77 traits remained for analysis, see Methods for further
...
the regression in the middle 90\% or the trait distribution, leaving
75 traits (150 tails) for analysis. Extended Data Table 1 lists all 77
traits and their available sanple sizes.
