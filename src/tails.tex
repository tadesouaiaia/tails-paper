...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   INTRO  %%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Introduction}  \label{sec:intro} %\hyperref[sec:intro]{Intro} 
...
\caption{\footnotesize{\textbf{Technical Schematic. \\
Panels (a-d), under a standard polygenic model:}} %\\  
\textbf{(a)} Trumpet plots illustrates the relationship between allele frequency and effect size. 
\textbf{(b)} Common alleles contribute to a greater proportion of heritability, this fraction is 
constant across the trait continuum. 
\textbf{(c)} PRS-On-Phenotype plots demonstrate a monotonic relationship between trait quantile and genetic risk. 
\textbf{(d)} Siblings of individuals in the trait tails moderately regress to the mean. \\ 
{\textbf{Panels (e-h), when strong stabilising selection is present:}}
\textbf{(e)} Trumpet plot shows that common variants of large effect are selected out. 
\textbf{(f)} Common alleles contribute to a greater proportion of heritability in the trait body, rare alleles predominate 
in the tails. 
\textbf{(g)} PRS-On-Phenotype plots show tail trait quantiles not associated with extreme phenotype. 
\textbf{(h)} Siblings of individuals harbouring large effect de novo variants resemble the background population. 
} 
\label{fig1} \end{figure} \FloatBarrier 


\noindent We hypothesise that the degree and type of selection that a complex trait is subject to determines 
...
of large-effect, rare alleles in trait tails (\fref{fig1}). The infinitesimal model, outlined in a 
...
After quality control (QC) steps (see \hyperref[sec:methods]{Methods}),
...
After standard QC of the genotype data (see \hyperref[sec:methods]{Methods}),
...
is applied to the lower and upper trait centiles (see \hyperref[sec:methods]{Methods}). 
...
%TRAIT TAIL CASE/CONTROL_DEFN 0-5 5-15 15-25 25-35 35-45 45-55 55-65 65-75 75-85 85-95 95-100
%30020 LOWER 1 EXPECTED_ODDS 3.64 2.28 1.74 1.44 1.19 1.0 0.87 0.74 0.56 0.43 0.25
%30020 LOWER 1 OBSERVED_ODDS 1.533 1.22 1.09 1.151 0.996 1.0 0.832 0.81 0.807 0.725 0.632
%TRAIT TAIL CASE/CONTROL_DEFN 0-5 5-15 15-25 25-35 35-45 45-55 55-65 65-75 75-85 85-95 95-100
%30020 UPPER 1 EXPECTED_ODDS 0.24 0.41 0.55 0.7 0.85 1.0 1.19 1.36 1.66 2.18 3.4
%30020 UPPER 1 OBSERVED_ODDS 0.282 0.491 0.599 0.687 0.905 1.0 1.102 1.369 1.616 1.961 3.513
%TRAIT TAIL CASE/CONTROL_DEFN 0-5 5-15 15-25 25-35 35-45 45-55 55-65 65-75 75-85 85-95 95-100
%30020 LOWER 25 EXPECTED_ODDS 2.25 1.67 1.41 1.24 1.11 1.0 0.91 0.82 0.72 0.59 0.43
%30020 LOWER 25 OBSERVED_ODDS 2.194 1.625 1.394 1.217 1.106 1.0 0.894 0.789 0.688 0.577 0.418
%TRAIT TAIL CASE/CONTROL_DEFN 0-5 5-15 15-25 25-35 35-45 45-55 55-65 65-75 75-85 85-95 95-100
%30020 UPPER 25 EXPECTED_ODDS 0.42 0.58 0.7 0.81 0.9 1.0 1.1 1.23 1.39 1.65 2.2
%30020 UPPER 25 OBSERVED_ODDS 0.376 0.583 0.69 0.786 0.881 1.0 1.133 1.217 1.496 1.784 2.441
%TRAIT TAIL CASE/CONTROL_DEFN 0-5 5-15 15-25 25-35 35-45 45-55 55-65 65-75 75-85 85-95 95-100
%30070 LOWER 1 EXPECTED_ODDS 4.38 2.66 1.92 1.55 1.25 1.0 0.87 0.7 0.52 0.4 0.19
%30070 LOWER 1 OBSERVED_ODDS 5.052 3.178 2.358 1.722 1.422 1.0 0.909 0.712 0.58 0.466 0.245
%TRAIT TAIL CASE/CONTROL_DEFN 0-5 5-15 15-25 25-35 35-45 45-55 55-65 65-75 75-85 85-95 95-100
%30070 UPPER 1 EXPECTED_ODDS 0.19 0.35 0.51 0.66 0.8 1.0 1.18 1.43 1.83 2.45 4.44
%30070 UPPER 1 OBSERVED_ODDS 0.894 0.818 1.035 1.041 1.035 1.0 1.235 1.289 1.259 1.513 1.674
%TRAIT TAIL CASE/CONTROL_DEFN 0-5 5-15 15-25 25-35 35-45 45-55 55-65 65-75 75-85 85-95 95-100
%30070 LOWER 25 EXPECTED_ODDS 2.5 1.8 1.47 1.28 1.13 1.0 0.89 0.78 0.68 0.54 0.37
%30070 LOWER 25 OBSERVED_ODDS 2.79 1.926 1.549 1.334 1.091 1.0 0.852 0.741 0.634 0.484 0.309
%TRAIT TAIL CASE/CONTROL_DEFN 0-5 5-15 15-25 25-35 35-45 45-55 55-65 65-75 75-85 85-95 95-100
%30070 UPPER 25 EXPECTED_ODDS 0.37 0.54 0.67 0.78 0.89 1.0 1.12 1.26 1.47 1.79 2.49
%30070 UPPER 25 OBSERVED_ODDS 0.404 0.549 0.673 0.782 0.907 1.0 1.123 1.306 1.484 1.822 2.471
...
PRS in the second half for the analysis (see \hyperref[sec:methods]{Methods}). 
...
POPout overall, 97 (91\%) showed POPout effects in the 
...
%\need{we can't say the next thing} 
%and we calculate PRS in the 
%independent replication samples by 
%treating the primary analysis data as a training set (see \hyperref[sec:methods]{Methods}). 
...
STANDout (\hyperref[sec:methods:sibs]{Sibling Methods}). 
...
Mendelian variants. 
\textbf{(b)}
Index sibling trait quantile (in 1\% increments) plotted against
mean trait value of conditional sibling in quantile for the four
traits selected with different POPout characteristics. (Fig 2a). 
\textbf{(c)} POPout P-values plotted against meta analysis
...
\textbf{(d)} LDscore regression SNP
...
Rare and Ultra Rare correspond to MAF<1\% and MAF<0.05\%, respectively.  Large denotes variant 
    effect sizes above 1 or below 1.  Strong and weak selection are \need{yeah i dunno}. 
...
data (see \hyperref[sec:methods]{Methods}). 
...
%--- final few ‘big sell’ sentences to insert here ---
%[Notes
%Some traits also show polygenicity! 
%Opened up a new perspective on GA.. and a new angle on detecting rare variants… and on selection… Future work can build on this to explicitly infer composition of causes of individual trait values and disease risk. 
%Here we devised and applied multiple approaches to interrogate how genetic architecture varies across the trait continuum, shedding new light on the role of selection in shaping how present-day genetic variation underpins human phenotypic variation.
% Despite significant advances over multiple decades in our understanding of genetic architecture, there has been little insight into how this architecture maps onto individuals residing at different points along a trait’s distribution. Thus, it was unknown whether common and rare alleles are spread uniformly across trait distributions, if certain traits have concentrations of rare alleles in specific trait quantiles, or whether an individual’s extreme trait value is more likely due to a monogenic, oligogenic or polygenic effects.]
...
We also calculated the correlation between the bootstrap 
...
\subsubsection*{Sibling-based Analyses} 


\paragraph*{Sibling-based Investigation of Departures from Polygenic Architecture} \label{sec:methods:sibs} ~\\ 
