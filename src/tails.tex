...
participants, involving baseline and follow-up surveys and assaying of biological measures across thousands of phenotypes, as well as linkage to health and disease record data, recruited across  the United Kingdom from 2006 to 2010 \citep{ukb}. The genetic dataset consists of 488,377 samples genotyped at 805,426 SNPs. To determine 
...
continuous traits  \need{we don't have this information about the numbers of traits in all of us} from individuals of multiple ancestries from across
...
similar. \need{European ancestry individuals were extract by using genetic ancestory groupings provided by All of Us, of which the ancestry categories correspond to definitions used within gnomAD, the Human Genome Diversity Project, and 1000 Genomes}.
...
summary statistics of each trait with fast-scoring to
