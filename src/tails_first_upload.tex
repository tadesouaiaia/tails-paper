...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage \newpage 
\section*{Results} \label{sec:results} The traits analyzed in the
following section were selected by first considering all continuous
(at least 10 unique values) traits in the UK Biobank (UKB) from three
major categories: \textit{Biomarkers}, \textit{Physical Measures} and
the \textit{Touchscreen Questionnaire \& Cognitive Tests}.  Traits
were standardised by regressing out the effects of age, sex, and known
environmental and technical factors and inverse-normal transforming
(see \textit{Methods}).  Samples were split in half, GWAS
was carried out using plink \cite{bt_10} and heritability and
pairwise genetic correlation was estimated using LDscore \cite{ldsc}.
Applying quality controls for sample size, heritability, skew, and
removing strongly correlated traits left 74 four traits for analysis
(see \textit{Methods2}), which were analyzed for POPout and associated
analyses across large number of European ancestry samples in the UK
Biobank.  This result was replicated across the subset of repeated
measures European ancestry samples in the UK Biobank, across the
subset of non-European ancestry samples in the UK Biobank, and, where
applicable across European ancestry samples in the All Of Us Biobank
(see \textit{Replication}).
...
MAF vrersus effect size, for genome-wide significant
