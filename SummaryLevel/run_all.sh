...
# STEP 2) Make Figures 
./code/tails.py gen all --in output_qc/qc.pass.txt --vals data/trait_data/vals/*.vals --pts data/trait_data/pts/*.pts  --simPath data/trait_sims/ --out output_figs/ --saveSrc --makeSheets --figFormats pdf jpeg 
