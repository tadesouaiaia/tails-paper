...
demonstrated that rare polygenic risk scores (PRS), calculated based on the PrimateAI-3D algorithm, 
...
a novel method that uses PRS \cite{Choi2020} to detect deviations 
...
from the UK Biobank, in individuals with repeated measures, and in the US-based All of Us cohort \cite{Bick2024}. Next, we employ an 
...
selection may driven these patterns  (\fref{fig4}). Extending a method \cite{Sanjak2018} that 
...
exome sequence data to date, and here we utilise their 
...
of the real data analyses (\dref{fig4}{e}). These simulations suggest that selection can 
