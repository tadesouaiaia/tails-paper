...
\subsubsection*{Power of POPout replication analyses}
\paragraph{Power of replication analyses}
...
\subsubsection*{Heritability attributable to genetic effects not included in
  the PRS}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection*{Forward-in-time simulation} \label{sec:methods:sims} 
...
\section*{Rare variant annotation}
...
\section*{Alternative POPout tail quantiles} 
...
\section*{Comparison of lifetime reproductive success results to Sanjak et al.}
...
\section*{Sensitivity of lifetime reproductive success analyses to BIC Model choice}
